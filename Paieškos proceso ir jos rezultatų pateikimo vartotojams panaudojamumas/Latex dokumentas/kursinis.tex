...
\subsection{Euristinis vertinimas}

Antrame stulpelyje yra defekto sunkumas (DS) vertinamas skalėje nuo 0 iki 3, kur 0 - nėra defekto, 1 - kosmetinis defektas, 2 - lengvas defektas, 3 - kritinis defektas trugdantis naudotis sistema.

\begin{center}
\begin{tabular}{ | p{5cm} | p{0,5cm} | p{10cm} | } 
 \hline
...
\end{tabular}
\captionof{table}{Euristinio vertinimo lentelė}\label{euristikųlentelėprad}
\end{center}
