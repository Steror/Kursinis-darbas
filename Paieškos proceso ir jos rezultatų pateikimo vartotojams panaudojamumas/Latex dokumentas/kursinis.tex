...
\begin{tabular}{ | p{4cm} | p{0,5cm} | p{11cm} | } 
 \hline
	...
	3) Naudotojo valdomas dialogas & 2 & Dalis puslapių nerodo nukeliauto kelio (\ref{img:atvaizdavimoklaida} pav.). \\ \hline
...
\section{Galutinio sprendimo prototipas}
...
Šiame skyriuje pavaizduotas autoriaus sukurtas prototipas siekiantis išspręsti tinklapio panaudojamumo problemas pastebėtas praėjusiame skyriuje. Yra daugybė prototipavimo įrankių: Justinmind, Adobe XD, Axure RP, ProtoPie ir kiti. Šiuo atveju naudojamas Justinmind vartotojo sąsajos prototipavimo įrankis. Šis įrankis nemokamas, turi gerus atsiliepimus ir yra lengvas naudoti, tačiau būtų galima naudoti ir alternatyvius įrankius.
