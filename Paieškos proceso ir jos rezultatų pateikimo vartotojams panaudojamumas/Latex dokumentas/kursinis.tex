...
Šiame darbe tiriami informacijos paieškos sprendimai pagerinantys Vilniaus universiteto ligoninės (VUL) Santaros klinikų internetinio puslapio santa.lt panaudojamumą. Tyrime bus atsižvelgta į navigaciją, informacijos paieškos procesą bei gautų rezultatų pateikimą.

VUL Santaros klinikos yra viena didžiausių Lietuvos ligoninių. Joje dirba virš 5000 darbuotojų, o per metus gydoma apie 1 milijonas ambulatorinių (ateinančių iš namų) pacientų. Šiais laikais darosi vis populiariau ieškoti informacijos ir registruotis internetu, taigi santa.lt puslapyje turėtų būti lengva surasti reikiamą informaciją. Tačiau dabartinė puslapio architektūra turi spragų informacijos paieškos srityje ir naudotojas gali nerasti reikiamos informacijos.
