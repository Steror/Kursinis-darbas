...
\end{enumerate}
\vspace{1cm}
Iš peržvalgos matoma, kad puslapis nepritaikytas mobiliems įrenginiams. Tai yra didelė problema, nes mobilieji įrenginiai vis plačiau naudojami ir šių įrenginių vartotojai turėtų galėti laisvai naudotis puslapiu.
