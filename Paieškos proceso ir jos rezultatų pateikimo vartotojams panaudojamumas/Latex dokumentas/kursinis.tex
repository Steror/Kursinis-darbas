...
Šioje srityje nedaug klaidų, tačiau kelios iš jų išsiskiria kaip svarbesnės už kitas. Navigacijos sistema yra per siaura pradiniuose lygiuose, todėl į vieną skyrių sueina per daug įvairių elementų. Dėl to kategorijų pavadinimai negali tiksliai apibūdinti informacijos viduje ir sistema turi daugiau lygių, negu galbūt reikėtų.
