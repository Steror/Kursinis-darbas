...
Šiame darbe tiriami informacijos paieškos sprendimai tinkantys Santaros Klinikų internetiniui puslapiui santa.lt. Tyrime bus atsižvelgta į navigaciją, informacijos paieškos procesą bei gautų rezultatų pateikimą.

Vilniaus Universiteto ligoninė Santaros klinikos yra viena didžiausių Lietuvos ligoninių. Joje dirba virš 5000 darbuotojų, o per metus gydoma apie 1 milijonas ambulatorinių pacientų. Šiais laikais darosi vis populiariau ieškoti informacijos ir registruotis internetu, taigi pacientams gali tekti naudotis santa.lt puslapiu.
%Naudojantis internetinių puslapių paslaugomis mes įprastai nepastebime puslapio navigacijos elementų, kol šie patenkina mūsų lūkesčius. Tačiau, kai reikia rasti informaciją ir tai padaryti nepavyksta arba norime greitai ir be pastangų palyginti rezultatus, bet parodoma gausybė skaičių
